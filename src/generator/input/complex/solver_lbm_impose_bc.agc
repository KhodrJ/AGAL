...
KERNEL_REQUIRE const ufloat_t dx_L_g                         | (ufloat_g_t)dxf_vec[L]
...
KERNEL_REQUIRE const ufloat_t *__restrict__ cells_f_F_aux    | mesh->c_cells_f_F_aux[i_dev]
...
KERNEL_REQUIRE const int force_type                          | S_FORCE_TYPE
KERNEL_REQUIRE const int bc_type                             | S_BC_TYPE
