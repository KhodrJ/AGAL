...
OUTFOR i_qj_q 3   0 Nqx 1   0 Nqx 1
    ...
    INFOR q 1   1 Lsize 1
        INIF (Lc0(<q>) >= 0) and (Lc1(<q>) >= 0) and (Lc2(<q>) >= 0)
            ...
            #INFOR lmn 1   0 2 1   0 2 1   0 2 1
                #INIF (gI(<l>+2*<m>+4*<n>) > 0) and ( (Lc0(<q>)-<l> >= 0) and (Lc1(<q>)-<m> >= 0) and (Lc2(<q>)-<n> >= 0) )
                    #// Consider nbr (<l><m><n>).
                    
                    #OUTIF (gNa( gCOND(<l>:1,(i_q==Nqx-1),0,gCOND(Lc0(<q>):0,true,def.,(i_q<Nqx-1))) and gCOND(<m>:1,(j_q==Nqx-1),0,gCOND(Lc1(<q>):0, true,def.,(j_q<Nqx-1))) and gCOND(<n>:1,(k_q==Nqx-1),0,gCOND(Lc2(<q>):0,true,def.,(k_q<Nqx-1))) ))
                        #REG nbr_id_<q> = nbr_id_global_LBM_nbr(gI(<l>),gI(<m>),gI(<n>));
                        #REG nbr_id_<q> = nbr_id_global
                    #END_OUTIF
                #END_INIF
            #END_INFOR
            INFOR p 1   1 Lsize 1
    ...
    INFOR p 1   1 Lsize 1
        INIF  ( (Ldim==2)and((<p>==1)or((<p>+1)%3==0)) ) or ( (Ldim==3)and( (((<p>-1)%2==0)and(<p><25))or(<p>==26) ) ) 
            ...
            END_INIF
            REG __syncthreads();
            #REG s_F_p[H_INDEX(Ldim,0,0,0)END_H_INDEX] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + <p>*n_maxcells;];
            REG-vc s_F_p[(I+1)+6*(J+1)+gCOND(Ldim: 2,0, def.,36*(K+1))] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + <p>*n_maxcells];
            #REG s_F_pb[H_INDEX(Ldim,0,0,0)END_H_INDEX] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + Lpb(<p>)*n_maxcells];
                ...
                INIF  (Lc0(<q>) >= 0) and (Lc1(<q>) >= 0) and (Lc2(<q>) >= 0) 
                    ...
                    INIF  (Lc0(<p>)==Lc0(<q>) or Lc0(<q>)==0) and (Lc1(<p>)==Lc1(<q>) or Lc1(<q>)==0) and (Lc2(<p>)==Lc2(<q>) or Lc2(<q>)==0)
                        ...
                        OUTIF (nbr_kap_b >= 0)
                            ...
                            #OUTIF LBM_COND_BC( 0,Lc0(Lpb(<q>)),  0,Lc1(Lpb(<q>)),  0,Lc2(Lpb(<q>)) )END_LBM_COND_BC
                                ...
                                #REG s_F_pb[H_LIMIT( Ldim,Lc0(<q>),Lc1(<q>),Lc2(<q>) )END_H_LIMIT] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + Lpb(<p>)*n_maxcells];
                    ...
                    INIF  (Lc0(Lpb(<p>))==Lc0(<q>) or Lc0(<q>)==0) and (Lc1(Lpb(<p>))==Lc1(<q>) or Lc1(<q>)==0) and (Lc2(Lpb(<p>))==Lc2(<q>) or Lc2(<q>)==0)
                        ...
                        OUTIF (nbr_kap_b >= 0)
                            ...
                            #OUTIF LBM_COND_BC( 0,Lc0(Lpb(<q>)),  0,Lc1(Lpb(<q>)),  0,Lc2(Lpb(<q>)) )END_LBM_COND_BC
                                ...
                                #REG s_F_p[H_LIMIT( Ldim,Lc0(<q>),Lc1(<q>),Lc2(<q>) )END_H_LIMIT] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + <p>*n_maxcells];
            ...
            #OUTIF s_F_pb[H_INDEX(Ldim,Lc0(<p>),Lc1(<p>),Lc2(<p>))END_H_INDEX] >= 0
                ...
                #s_F_pb[H_INDEX(Ldim,Lc0(<p>),Lc1(<p>),Lc2(<p>))END_H_INDEX];
            END_OUTIF
            OUTIF (s_F_p[(I+1+Lc0(Lpb(<p>)))+6*(J+1+Lc1(Lpb(<p>)))+gCOND(Ldim: 2,0, def.,36*(K+1+Lc2(Lpb(<p>))))] >= 0)
            #OUTIF s_F_p[H_INDEX(Ldim,Lc0(Lpb(<p>)),Lc1(Lpb(<p>)),Lc2(Lpb(<p>)))END_H_INDEX] >= 0
                ...
                #s_F_p[H_INDEX(Ldim,Lc0(Lpb(<p>)),Lc1(Lpb(<p>)),Lc2(Lpb(<p>)))END_H_INDEX];
            END_OUTIF
            ...
            INFOR q 1   1 Lsize 1
                INIF  (Lc0(<q>) >= 0) and (Lc1(<q>) >= 0) and (Lc2(<q>) >= 0) 
                    ...
                    INIF  (Lc0(<p>)==Lc0(<q>) or Lc0(<q>)==0) and (Lc1(<p>)==Lc1(<q>) or Lc1(<q>)==0) and (Lc2(<p>)==Lc2(<q>) or Lc2(<q>)==0)
                        ...
                        REG nbr_Q_b = nbr_Q_<q>;
                        REG nbr_kap_b = nbr_id_<q>;
                        #OUTIF (nbr_kap_b >= 0) and LBM_COND_BC( 0,Lc0(Lpb(<q>)),  0,Lc1(Lpb(<q>)),  0,Lc2(Lpb(<q>)) )END_LBM_COND_BC
                        OUTIF ((nbr_kap_b >=0) and (gNa( (gCOND(Lc0(Lpb(<q>)): 1,I==4-1,-1,I==0,def.,true)) and (gCOND(Lc1(Lpb(<q>)): 1,J==4-1,-1,J==0,def.,true)) and (gCOND(Lc2(Lpb(<q>)): 1,K==4-1,-1,K==0,def.,true)) ))) 
                         
                            OUTIF (s_F_p[\
                                (I+1+Lc0(Lpb(<p>))+(Lc0(<q>)*4)) + 6*(J+1+Lc1(Lpb(<p>))+(Lc1(<q>)*4)) + gCOND(Ldim: 2,0, 3,36*(K+1+Lc2(Lpb(<p>))+(Lc2(<q>)*4)))\
                                ] >= 0)
                            #OUTIF s_F_p[H_COMBO(Ldim,Lc0(Lpb(<p>)),Lc0(<q>),  Lc1(Lpb(<p>)),Lc1(<q>), Lc2(Lpb(<p>)),Lc2(<q>))END_H_COMBO] >= 0
                                REG-vc cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + Lpb(<p>)*n_maxcells] = s_F_p[\
                                    (I+1+Lc0(Lpb(<p>))+(Lc0(<q>)*4)) + 6*(J+1+Lc1(Lpb(<p>))+(Lc1(<q>)*4)) + gCOND(Ldim: 2,0, 3,36*(K+1+Lc2(Lpb(<p>))+(Lc2(<q>)*4)))\
                                ];
                                #H_COMBO(Ldim,Lc0(Lpb(<p>)),Lc0(<q>),  Lc1(Lpb(<p>)),Lc1(<q>), Lc2(Lpb(<p>)),Lc2(<q>))END_H_COMBO];
                            END_OUTIF
                    ...
                    INIF  (Lc0(Lpb(<p>))==Lc0(<q>) or Lc0(<q>)==0) and (Lc1(Lpb(<p>))==Lc1(<q>) or Lc1(<q>)==0) and (Lc2(Lpb(<p>))==Lc2(<q>) or Lc2(<q>)==0)
                        ...
                        OUTIF ((nbr_kap_b >=0 ) and (gNa( (gCOND(Lc0(Lpb(<q>)): 1,I==4-1,-1,I==0,def.,true)) and (gCOND(Lc1(Lpb(<q>)): 1,J==4-1,-1,J==0,def.,true)) and (gCOND(Lc2(Lpb(<q>)): 1,K==4-1,-1,K==0,def.,true)) )))
                            ...
                            #OUTIF s_F_pb[H_COMBO(Ldim,Lc0(<p>),Lc0(<q>),  Lc1(<p>),Lc1(<q>),  Lc2(<p>),Lc2(<q>))END_H_COMBO] >= 0
                                REG-vc cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + <p>*n_maxcells] = s_F_pb[\
                                    (I+1+Lc0(<p>)+(Lc0(<q>)*4)) + 6*(J+1+Lc1(<p>)+(Lc1(<q>)*4)) + gCOND(Ldim: 2,0, 3,36*(K+1+Lc2(<p>)+(Lc2(<q>)*4)))\
                                ];
                                #H_COMBO(Ldim,Lc0(<p>),Lc0(<q>),  Lc1(<p>),Lc1(<q>),  Lc2(<p>),Lc2(<q>))END_H_COMBO];
                            END_OUTIF
