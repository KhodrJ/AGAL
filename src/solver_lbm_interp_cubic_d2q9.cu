...
)
{
	...
	ufloat_t A20 = N_Pf(0.0);
	ufloat_t A30 = N_Pf(0.0);
	ufloat_t A01 = N_Pf(0.0);
	ufloat_t A11 = N_Pf(0.0);
	ufloat_t A21 = N_Pf(0.0);
	ufloat_t A31 = N_Pf(0.0);
	ufloat_t A02 = N_Pf(0.0);
	ufloat_t A12 = N_Pf(0.0);
	ufloat_t A22 = N_Pf(0.0);
	ufloat_t A32 = N_Pf(0.0);
	ufloat_t A03 = N_Pf(0.0);
	ufloat_t A13 = N_Pf(0.0);
	ufloat_t A23 = N_Pf(0.0);
	ufloat_t A33 = N_Pf(0.0);
	...
	for (int k = 0; k < M_LBLOCK; k += 1)
	{
		...
		if (i_kap_b > -1 && (((interp_type==0)and(block_on_interface==1))or((interp_type==1)and(cells_ID_mask[i_kap_b]==V_REF_ID_MARK_REFINE))))
		{
			...
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+0)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_0 = (N_Pf(0.444444444444444)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.444444444444444)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				f_1 = (N_Pf(0.111111111111111)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.111111111111111)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				f_2 = (N_Pf(0.111111111111111)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.111111111111111)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				aux_1yx = (   (N_Pf(0.0)*N_Pf(-1.0))*rho*v_x + N_Pf(1.5)*(N_Pf(0.0)*N_Pf(-1.0))*(N_Pf(-1.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x) + N_Pf(0.0)*(rho_y*v*u + rho*v_y*u + rho*v*u_y))   ) - (N_Pf(0.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x));
				aux_1yy = (   (N_Pf(0.0)*N_Pf(0.0)-N_Pf(0.3333333333333333))*rho*v_y + N_Pf(1.5)*(N_Pf(0.0)*N_Pf(0.0)-N_Pf(0.3333333333333333))*(N_Pf(-1.0)*(rho_x*v*v + rho*v_x*v + rho*v*v_x) + N_Pf(0.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y))   ) - (N_Pf(0.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y));
				f_3 = (N_Pf(0.111111111111111)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.111111111111111)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				aux_1yx = (   (N_Pf(-1.0)*N_Pf(0.0))*rho*v_x + N_Pf(1.5)*(N_Pf(-1.0)*N_Pf(0.0))*(N_Pf(0.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x) + N_Pf(-1.0)*(rho_y*v*u + rho*v_y*u + rho*v*u_y))   ) - (N_Pf(-1.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x));
				aux_1yy = (   (N_Pf(-1.0)*N_Pf(-1.0)-N_Pf(0.3333333333333333))*rho*v_y + N_Pf(1.5)*(N_Pf(-1.0)*N_Pf(-1.0)-N_Pf(0.3333333333333333))*(N_Pf(0.0)*(rho_x*v*v + rho*v_x*v + rho*v*v_x) + N_Pf(-1.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y))   ) - (N_Pf(-1.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y));
				f_4 = (N_Pf(0.111111111111111)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.111111111111111)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				f_5 = (N_Pf(0.027777777777778)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.027777777777778)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
				...
				aux_1yx = (   (N_Pf(1.0)*N_Pf(-1.0))*rho*v_x + N_Pf(1.5)*(N_Pf(1.0)*N_Pf(-1.0))*(N_Pf(-1.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x) + N_Pf(1.0)*(rho_y*v*u + rho*v_y*u + rho*v*u_y))   ) - (N_Pf(1.0)*(rho_x*v*u + rho*v_x*u + rho*v*u_x));
				aux_1yy = (   (N_Pf(1.0)*N_Pf(1.0)-N_Pf(0.3333333333333333))*rho*v_y + N_Pf(1.5)*(N_Pf(1.0)*N_Pf(1.0)-N_Pf(0.3333333333333333))*(N_Pf(-1.0)*(rho_x*v*v + rho*v_x*v + rho*v*v_x) + N_Pf(1.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y))   ) - (N_Pf(1.0)*(rho_y*v*v + rho*v_y*v + rho*v*v_y));
				f_6 = (N_Pf(0.027777777777778)*rho*(N_Pf(1.0) + N_Pf(3.0)*cdotu + N_Pf(4.5)*cdotu*cdotu - N_Pf(1.5)*udotu)) - tau_Lp1*N_Pf(0.027777777777778)*N_Pf(3.0)*(aux_1xx + aux_1xy + aux_1yx + aux_1yy); 
