...
int Solver_LBM::S_ComputeProperties(int i_dev, int i_kap, ufloat_t dx_L, double *out)
{
	...
	{
#if (N_Q==9)
		ufloat_t f_0 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 0*n_maxcells];
		ufloat_t f_1 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 3*n_maxcells];
		ufloat_t f_2 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 4*n_maxcells];
		ufloat_t f_3 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 1*n_maxcells];
		ufloat_t f_4 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 2*n_maxcells];
		ufloat_t f_5 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 7*n_maxcells];
		ufloat_t f_6 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 8*n_maxcells];
		ufloat_t f_7 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 5*n_maxcells];
		ufloat_t f_8 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 6*n_maxcells];
...
#elif (N_Q==19)
		ufloat_t f_0 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 0*n_maxcells];
		ufloat_t f_1 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 2*n_maxcells];
		ufloat_t f_2 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 1*n_maxcells];
		ufloat_t f_3 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 4*n_maxcells];
		ufloat_t f_4 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 3*n_maxcells];
		ufloat_t f_5 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 6*n_maxcells];
		ufloat_t f_6 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 5*n_maxcells];
		ufloat_t f_7 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 8*n_maxcells];
		ufloat_t f_8 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 7*n_maxcells];
		ufloat_t f_9 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 10*n_maxcells];
		ufloat_t f_10 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 9*n_maxcells];
		ufloat_t f_11 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 12*n_maxcells];
		ufloat_t f_12 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 11*n_maxcells];
		ufloat_t f_13 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 14*n_maxcells];
		ufloat_t f_14 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 13*n_maxcells];
		ufloat_t f_15 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 16*n_maxcells];
		ufloat_t f_16 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 15*n_maxcells];
		ufloat_t f_17 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 18*n_maxcells];
		ufloat_t f_18 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 17*n_maxcells];
		...
		ufloat_t f_17 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 18*n_maxcells];
		ufloat_t f_18 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 17*n_maxcells];
		ufloat_t f_19 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 20*n_maxcells];
		ufloat_t f_20 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 19*n_maxcells];
		ufloat_t f_21 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 22*n_maxcells];
		ufloat_t f_22 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 21*n_maxcells];
		ufloat_t f_23 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 24*n_maxcells];
		ufloat_t f_24 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 23*n_maxcells];
		ufloat_t f_25 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 26*n_maxcells];
		ufloat_t f_26 = mesh->cells_f_F[i_dev][i_kap*M_CBLOCK + kap_i + 25*n_maxcells];
