...
int Geometry<ufloat_t,ufloat_g_t,AP>::G_Convert_IndexListsToCoordList(int i_dev)
{
...
// TODO
template <typename ufloat_t, typename ufloat_g_t, const ArgsPack *AP>
int Geometry<ufloat_t,ufloat_g_t,AP>::G_Convert_CoordListToIndexLists(int i_dev)
{
