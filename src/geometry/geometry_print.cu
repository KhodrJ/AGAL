...
//         ufloat_g_t v3z = geom_f_face_X[i + 8*n_faces_a];
        ufloat_g_t v1x = geom_f_face_Xt[0 + i*NVDP];
        ufloat_g_t v1y = geom_f_face_Xt[1 + i*NVDP];
        ufloat_g_t v1z = geom_f_face_Xt[2 + i*NVDP];
        ufloat_g_t v2x = geom_f_face_Xt[3 + i*NVDP];
        ufloat_g_t v2y = geom_f_face_Xt[4 + i*NVDP];
        ufloat_g_t v2z = geom_f_face_Xt[5 + i*NVDP];
        ufloat_g_t v3x = geom_f_face_Xt[6 + i*NVDP];
        ufloat_g_t v3y = geom_f_face_Xt[7 + i*NVDP];
        ufloat_g_t v3z = geom_f_face_Xt[8 + i*NVDP];
        ufloat_t n1;
        ufloat_t n2;
        ufloat_t n3;
if (N_DIM==2)
