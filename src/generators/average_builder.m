...
% Open files.
fileID_d2q9 = fopen("../solver_lbm_average_d2q9.cu",'w');
fileID_d3q19 = fopen("../solver_lbm_average_d3q19.cu",'w');
fileID_d3q27 = fopen("../solver_lbm_average_d3q27.cu",'w');
...
for K = 1:3
	...
	% Build C++ routine to call averaging kernel.
	add_line(fileID{K});
	add_line(fileID{K});
	%
