...
% Open files.
fileID_d2q9 = fopen("./out/solver_lbm_collide_d2q9.cu",'w');
fileID_d3q19 = fopen("./out/solver_lbm_collide_d3q19.cu",'w');
fileID_d3q27 = fopen("./out/solver_lbm_collide_d3q27.cu",'w');
