		...
		if ( i_kap_b > -1 && (i_kap_bc < 0 || block_on_boundary == 1) )
		{
			...
			if (block_on_boundary == 1)
			{
				...
				if ((I_kap+1==Nbx) && (J_kap+1< Nbx) && (K_kap+1< Nbx))
				{
					...
					// p = 21
				if ((I_kap+1==Nbx) && (J_kap+1< Nbx) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(0.050000000000000);
					...
					// p = 23
				if ((I_kap+1==Nbx) && (J_kap-1>= 0) && (K_kap+1< Nbx))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(0.050000000000000);
					...
					// p = 26
				if ((I_kap+1==Nbx) && (J_kap-1>= 0) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(0.050000000000000);
				...
				if ((I_kap-1==-1) && (K_kap+1< Nbx))
				{
					...
					// p = 20
				if ((I_kap-1==-1) && (J_kap-1>= 0) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
					...
					// p = 22
				if ((I_kap-1==-1) && (J_kap-1>= 0) && (K_kap+1< Nbx))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
					...
					// p = 24
				if ((I_kap-1==-1) && (J_kap+1< Nbx) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((I_kap+1< Nbx) && (J_kap+1==Nbx) && (K_kap-1>= 0))
				{
					...
					// p = 24
				if ((I_kap-1>= 0) && (J_kap+1==Nbx) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
					...
					// p = 25
				if ((I_kap-1>= 0) && (J_kap+1==Nbx) && (K_kap+1< Nbx))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((J_kap-1==-1) && (K_kap+1< Nbx))
				{
					...
					// p = 20
				if ((I_kap-1>= 0) && (J_kap-1==-1) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
					...
					// p = 22
				if ((I_kap-1>= 0) && (J_kap-1==-1) && (K_kap+1< Nbx))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((I_kap+1< Nbx) && (J_kap-1==-1) && (K_kap+1< Nbx))
				{
					...
					// p = 26
				if ((I_kap+1< Nbx) && (J_kap-1==-1) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(0.050000000000000);
				...
				if ((I_kap+1< Nbx) && (J_kap+1< Nbx) && (K_kap+1==Nbx))
				{
					...
					// p = 22
				if ((I_kap-1>= 0) && (J_kap-1>= 0) && (K_kap+1==Nbx))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((J_kap+1< Nbx) && (K_kap-1==-1))
				{
					...
					// p = 20
				if ((I_kap-1>= 0) && (J_kap-1>= 0) && (K_kap-1==-1))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((I_kap+1< Nbx) && (J_kap+1< Nbx) && (K_kap-1==-1))
				{
					...
					// p = 24
				if ((I_kap-1>= 0) && (J_kap+1< Nbx) && (K_kap-1==-1))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
					...
					// p = 26
				if ((I_kap+1< Nbx) && (J_kap-1>= 0) && (K_kap-1==-1))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(0.050000000000000);
				...
				if ((I_kap-1==-1) && (J_kap-1==-1))
				{
					...
					// p = 20
				if ((I_kap-1==-1) && (J_kap-1==-1) && (K_kap-1>= 0))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((I_kap-1==-1) && (K_kap-1==-1))
				{
					...
					// p = 20
				if ((I_kap-1==-1) && (J_kap-1>= 0) && (K_kap-1==-1))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
				...
				if ((J_kap-1==-1) && (K_kap-1==-1))
				{
					...
					// p = 20
				if ((I_kap-1>= 0) && (J_kap-1==-1) && (K_kap-1==-1))
				{
					if (nbr_kap_b == -6)
					{
						cdotu = N_Pf(-0.050000000000000);
...
int Solver_LBM::S_Collide_d3q27(int i_dev, int L)
{
	...
	{
		Cu_Collide_d3q27<<<(M_CBLOCK+mesh->n_ids[i_dev][L]-1)/M_CBLOCK,M_CBLOCK,0,mesh->streams[i_dev]>>>
		(
