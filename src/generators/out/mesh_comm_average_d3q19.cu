...
int Mesh::M_Average_d3q19(int i_dev, int L, int var, ufloat_t Cscale, ufloat_t Cscale2)
{
	if (n_ids[i_dev][L] > 0 && var == V_AVERAGE_INTERFACE)
	{
		Cu_Average_d3q19<0><<<(M_CBLOCK+n_ids[i_dev][L]-1)/M_CBLOCK,M_CBLOCK,0,streams[i_dev]>>>
		(
	...
	{
		Cu_Average_d3q19<1><<<(M_CBLOCK+n_ids[i_dev][L]-1)/M_CBLOCK,M_CBLOCK,0,streams[i_dev]>>>
		(
			n_ids[i_dev][L], c_id_set[i_dev][L], n_maxcells, dxf_vec[L+1], dxf_vec[L], Cscale, Cscale2,
			c_cblock_ID_onb[i_dev], c_cblock_ID_mask[i_dev], c_cblock_ID_nbr_child[i_dev], n_maxcblocks,
			c_cells_ID_mask[i_dev], c_cells_f_F[i_dev]
	...
	{
		Cu_Average_d3q19<2><<<(M_CBLOCK+n_ids[i_dev][L]-1)/M_CBLOCK,M_CBLOCK,0,streams[i_dev]>>>
		(
			n_ids[i_dev][L], c_id_set[i_dev][L], n_maxcells, dxf_vec[L+1], dxf_vec[L], Cscale, Cscale2,
			c_cblock_ID_onb[i_dev], c_cblock_ID_mask[i_dev], c_cblock_ID_nbr_child[i_dev], n_maxcblocks,
			c_cells_ID_mask[i_dev], c_cells_f_F[i_dev]
