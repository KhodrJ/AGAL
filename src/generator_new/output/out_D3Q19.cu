                        ...
                        for (int xc_k = 0; xc_k < 2; xc_k += 1)
                        {
                            for (int xc_i = 0; xc_i < 2; xc_i += 1)
                            {
                                for (int xc_j = 0; xc_j < 2; xc_j += 1)
                                {
                                    ...
                                    v = (((Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>+(Lc1(<p>))*f_<p>)) / rho;
