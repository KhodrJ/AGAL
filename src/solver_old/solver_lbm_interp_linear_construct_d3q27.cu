...
__global__
void Cu_Interpolate_Linear_Construct_d3q27
(
...
)
{
	...
	for (int k = 0; k < M_LBLOCK; k += 1)
	{
		...
		if (i_kap_b > -1 && (((interp_type==0)and(block_on_interface==1))or((interp_type==1)and(cells_ID_mask[i_kap_b]==V_REF_ID_MARK_REFINE))))
		{
			...
			u = (N_Pf(0.0)*f_0 +N_Pf(1.0)*f_1 +N_Pf(-1.0)*f_2 +N_Pf(0.0)*f_3 +N_Pf(0.0)*f_4 +N_Pf(0.0)*f_5 +N_Pf(0.0)*f_6 +N_Pf(1.0)*f_7 +N_Pf(-1.0)*f_8 +N_Pf(1.0)*f_9 +N_Pf(-1.0)*f_10 +N_Pf(0.0)*f_11 +N_Pf(0.0)*f_12 +N_Pf(1.0)*f_13 +N_Pf(-1.0)*f_14 +N_Pf(1.0)*f_15 +N_Pf(-1.0)*f_16 +N_Pf(0.0)*f_17 +N_Pf(0.0)*f_18 +N_Pf(1.0)*f_19 +N_Pf(-1.0)*f_20 +N_Pf(1.0)*f_21 +N_Pf(-1.0)*f_22 +N_Pf(1.0)*f_23 +N_Pf(-1.0)*f_24 +N_Pf(-1.0)*f_25 +N_Pf(1.0)*f_26 ) / rho;
			v = (N_Pf(0.0)*f_0 +N_Pf(0.0)*f_1 +N_Pf(0.0)*f_2 +N_Pf(1.0)*f_3 +N_Pf(-1.0)*f_4 +N_Pf(0.0)*f_5 +N_Pf(0.0)*f_6 +N_Pf(1.0)*f_7 +N_Pf(-1.0)*f_8 +N_Pf(0.0)*f_9 +N_Pf(0.0)*f_10 +N_Pf(1.0)*f_11 +N_Pf(-1.0)*f_12 +N_Pf(-1.0)*f_13 +N_Pf(1.0)*f_14 +N_Pf(0.0)*f_15 +N_Pf(0.0)*f_16 +N_Pf(1.0)*f_17 +N_Pf(-1.0)*f_18 +N_Pf(1.0)*f_19 +N_Pf(-1.0)*f_20 +N_Pf(1.0)*f_21 +N_Pf(-1.0)*f_22 +N_Pf(-1.0)*f_23 +N_Pf(1.0)*f_24 +N_Pf(1.0)*f_25 +N_Pf(-1.0)*f_26 ) / rho;
			w = (N_Pf(0.0)*f_0+N_Pf(0.0)*f_1+N_Pf(0.0)*f_2+N_Pf(0.0)*f_3+N_Pf(0.0)*f_4+N_Pf(1.0)*f_5+N_Pf(-1.0)*f_6+N_Pf(0.0)*f_7+N_Pf(0.0)*f_8+N_Pf(1.0)*f_9+N_Pf(-1.0)*f_10+N_Pf(1.0)*f_11+N_Pf(-1.0)*f_12+N_Pf(0.0)*f_13+N_Pf(0.0)*f_14+N_Pf(-1.0)*f_15+N_Pf(1.0)*f_16+N_Pf(-1.0)*f_17+N_Pf(1.0)*f_18+N_Pf(1.0)*f_19+N_Pf(-1.0)*f_20+N_Pf(-1.0)*f_21+N_Pf(1.0)*f_22+N_Pf(1.0)*f_23+N_Pf(-1.0)*f_24+N_Pf(1.0)*f_25+N_Pf(-1.0)*f_26) / rho;
			s_u[threadIdx.x] = u;
			s_v[threadIdx.x] = v;
			...
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+0)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 = N_Pf(0.0);
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+0)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 1.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+1)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+1)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 2.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+2)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+2)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 3.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+3)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+3)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 4.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+4)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+4)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 5.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+5)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+5)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 6.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+6)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+6)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
			//	Child 7.
			if ((interp_type == 0 && cells_ID_mask[(i_kap_bc+7)*M_CBLOCK + threadIdx.x]==2) || (interp_type == 1))
			{
				...
				f_19 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_19 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 20*n_maxcells] = f_19;
				f_20 = N_Pf(0.0);
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_20 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_20 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 19*n_maxcells] = f_20;
				f_21 = N_Pf(0.0);
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_21 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_21 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 22*n_maxcells] = f_21;
				f_22 = N_Pf(0.0);
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_22 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_22 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 21*n_maxcells] = f_22;
				f_23 = N_Pf(0.0);
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_23 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_23 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 24*n_maxcells] = f_23;
				f_24 = N_Pf(0.0);
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_24 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_24 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 23*n_maxcells] = f_24;
				f_25 = N_Pf(0.0);
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(-1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(-1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_25 += (N_Pf(-1.0)-u)*( (N_Pf(1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_25 += (N_Pf(1.0)-v)*( (N_Pf(1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 26*n_maxcells] = f_25;
				f_26 = N_Pf(0.0);
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(1.0)-u)*u_x + aux_1xx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(1.0)-u)*v_x + aux_1xy ) - aux_0;
				f_26 += (N_Pf(1.0)-u)*( (N_Pf(-1.0)-v)*u_y + aux_1yx ) - aux_0;
				f_26 += (N_Pf(-1.0)-v)*( (N_Pf(-1.0)-v)*v_y + aux_1yy ) - aux_0;
				cells_f_F[(i_kap_bc+7)*M_CBLOCK + threadIdx.x + 25*n_maxcells] = f_26;
			}
		}
	}
}

int Solver_LBM::S_Interpolate_Linear_Construct_d3q27(int i_dev, int L, int var, ufloat_t tau_L, ufloat_t tau_ratio_L)
{
	if (mesh->n_ids[i_dev][L] > 0 && var == V_INTERP_INTERFACE)
	{
		Cu_Interpolate_Linear_Construct_d3q27<0><<<(M_LBLOCK+mesh->n_ids[i_dev][L]-1)/M_LBLOCK,M_TBLOCK,0,mesh->streams[i_dev]>>>(mesh->n_ids[i_dev][L], n_maxcells, n_maxcblocks, v0, dxf_vec[L], tau_L, tau_ratio_L, &mesh->c_id_set[i_dev][L*n_maxcblocks], mesh->c_cells_ID_mask[i_dev], mesh->c_cells_f_F[i_dev], mesh->c_cblock_ID_nbr[i_dev], mesh->c_cblock_ID_nbr_child[i_dev], mesh->c_cblock_ID_mask[i_dev], mesh->c_cblock_ID_onb[i_dev]);
	}
	if (mesh->n_ids[i_dev][L] > 0 && var == V_INTERP_ADDED)
	{
		Cu_Interpolate_Linear_Construct_d3q27<1><<<(M_LBLOCK+mesh->n_ids[i_dev][L]-1)/M_LBLOCK,M_TBLOCK,0,mesh->streams[i_dev]>>>(mesh->n_ids[i_dev][L], n_maxcells, n_maxcblocks, v0, dxf_vec[L], tau_L, tau_ratio_L, &mesh->c_id_set[i_dev][L*n_maxcblocks], mesh->c_cblock_ID_ref[i_dev], mesh->c_cells_f_F[i_dev], mesh->c_cblock_ID_nbr[i_dev], mesh->c_cblock_ID_nbr_child[i_dev], mesh->c_cblock_ID_mask[i_dev], mesh->c_cblock_ID_onb[i_dev]);
	}
