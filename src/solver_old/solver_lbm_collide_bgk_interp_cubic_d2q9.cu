...
__global__
void Cu_Collide_BGK_Interpolate_Cubic_d2q9
(
...
)
{
	...
	for (int k = 0; k < M_LBLOCK; k += 1)
	{
		...
		if (i_kap_b > -1 && ((i_kap_bc<0)||(block_on_interface==1)))
		{
			...
			{
				x_kap = N_Pf(-0.083333333333333)+N_Pf(0.166666666666667)*I_kap;
				y_kap = N_Pf(-0.083333333333333)+N_Pf(0.166666666666667)*J_kap;
				//
				// DDF 0.
				//
