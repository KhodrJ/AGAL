...
__global__
void Cu_Stream_Original_D3Q27(int n_ids_idev_L,long int n_maxcells,int n_maxcblocks,int *id_set_idev_L,int *cells_ID_mask,ufloat_t *cells_f_F,int *cblock_ID_nbr,int *cblock_ID_nbr_child,int *cblock_ID_mask)
{
            ...
            for (int k_q = 0; k_q < Nqx; k_q += 1)
            {
                for (int i_q = 0; i_q < Nqx; i_q += 1)
                {
                    for (int j_q = 0; j_q < Nqx; j_q += 1)
                    {
                        ...
                        __syncthreads();
                        s_F_p[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 19*n_maxcells];
                        s_F_pb[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0))
                            {
                                s_F_pb[(I+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((K==0))
                            {
                                s_F_pb[(I+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0)and(J==0))
                            {
                                s_F_pb[(4+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0)and(K==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0)and(K==0))
                            {
                                s_F_pb[(I+1) + 6*(4+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            ...
                            {
                                s_F_pb[(4+1) + 6*(4+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells];
                            }
                        }
                        __syncthreads();
                        // Main writes.
                        if (cells_ID_mask[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x] > -1)
                        {
                            if (s_F_pb[(I+1+1)+6*(J+1+1)+36*(K+1+1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 19*n_maxcells] = s_F_pb[(I+1+1)+6*(J+1+1)+36*(K+1+1)];
                            }
                            if (s_F_p[(I+1+-1)+6*(J+1+-1)+36*(K+1+-1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[(I+1+-1)+6*(J+1+-1)+36*(K+1+-1)];
                            }
                        }
                        // Neighbor writes.
                        //\t Nbr 1 participates in an exchange for p=19.
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(0*4)) ];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_3;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)))
                        {
                            if (s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_5;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 7 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_7;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)and(J==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ];
                            }
                        }
                        //\t Nbr 9 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_9;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)and(K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 11 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_11;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)and(K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 19 participates in an exchange for p=19.
                        nbr_Q_b = nbr_Q_19;
                        nbr_kap_b = nbr_id_19;
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)and(J==0)and(K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 20*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        __syncthreads();
                        ...
                        __syncthreads();
                        s_F_p[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 21*n_maxcells];
                        s_F_pb[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 22*n_maxcells];
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0))
                            {
                                s_F_pb[(I+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for pb=Lpb(21).
                        nbr_Q_b = nbr_Q_5;
                        nbr_kap_b = nbr_id_5;
                        if (nbr_kap_b >= 0)
                        {
                            if ((K==0))
                            {
                                s_F_p[(I+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 21*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0)and(J==0))
                            {
                                s_F_pb[(4+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells];
                            }
                        }
                        __syncthreads();
                        // Main writes.
                        if (cells_ID_mask[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x] > -1)
                        {
                            if (s_F_pb[(I+1+1)+6*(J+1+1)+36*(K+1+-1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 21*n_maxcells] = s_F_pb[(I+1+1)+6*(J+1+1)+36*(K+1+-1)];
                            }
                            if (s_F_p[(I+1+-1)+6*(J+1+-1)+36*(K+1+1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 22*n_maxcells] = s_F_p[(I+1+-1)+6*(J+1+-1)+36*(K+1+1)];
                            }
                        }
                        // Neighbor writes.
                        //\t Nbr 1 participates in an exchange for p=21.
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+1+(0*4)) ];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for p=21.
                        nbr_Q_b = nbr_Q_3;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)))
                        {
                            if (s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells] = s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for pb=Lpb(21).
                        nbr_Q_b = nbr_Q_5;
                        ...
                        if ((nbr_kap_b >=0 ) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((K==0)))
                        {
                            if (s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 21*n_maxcells] = s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 7 participates in an exchange for p=21.
                        nbr_Q_b = nbr_Q_7;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)and(J==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 22*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ];
                            }
                        }
                        __syncthreads();
                        ...
                        __syncthreads();
                        s_F_p[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 23*n_maxcells];
                        s_F_pb[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 24*n_maxcells];
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for pb=Lpb(23).
                        nbr_Q_b = nbr_Q_3;
                        nbr_kap_b = nbr_id_3;
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0))
                            {
                                s_F_p[(I+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 23*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((K==0))
                            {
                                s_F_pb[(I+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells];
                            }
                        }
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0)and(K==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells];
                            }
                        }
                        __syncthreads();
                        // Main writes.
                        if (cells_ID_mask[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x] > -1)
                        {
                            if (s_F_pb[(I+1+1)+6*(J+1+-1)+36*(K+1+1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 23*n_maxcells] = s_F_pb[(I+1+1)+6*(J+1+-1)+36*(K+1+1)];
                            }
                            if (s_F_p[(I+1+-1)+6*(J+1+1)+36*(K+1+-1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 24*n_maxcells] = s_F_p[(I+1+-1)+6*(J+1+1)+36*(K+1+-1)];
                            }
                        }
                        // Neighbor writes.
                        //\t Nbr 1 participates in an exchange for p=23.
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(0*4)) ];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for pb=Lpb(23).
                        nbr_Q_b = nbr_Q_3;
                        ...
                        if ((nbr_kap_b >=0 ) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)))
                        {
                            if (s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 23*n_maxcells] = s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+1+(0*4)) ];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for p=23.
                        nbr_Q_b = nbr_Q_5;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells] = s_F_p[ (I+1+-1+(0*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 9 participates in an exchange for p=23.
                        nbr_Q_b = nbr_Q_9;
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)and(K==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 24*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        __syncthreads();
                        ...
                        __syncthreads();
                        s_F_p[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 26*n_maxcells];
                        s_F_pb[(I+1)+6*(J+1)+36*(K+1)] = cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 25*n_maxcells];
                        ...
                        if (nbr_kap_b >= 0)
                        {
                            if ((I==0))
                            {
                                s_F_pb[(4+1) + 6*(J+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 25*n_maxcells];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_3;
                        nbr_kap_b = nbr_id_3;
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0))
                            {
                                s_F_p[(I+1) + 6*(4+1) + 36*(K+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_5;
                        nbr_kap_b = nbr_id_5;
                        if (nbr_kap_b >= 0)
                        {
                            if ((K==0))
                            {
                                s_F_p[(I+1) + 6*(J+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells];
                            }
                        }
                        //\t Nbr 11 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_11;
                        nbr_kap_b = nbr_id_11;
                        if (nbr_kap_b >= 0)
                        {
                            if ((J==0)and(K==0))
                            {
                                s_F_p[(I+1) + 6*(4+1) + 36*(4+1)] = cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells];
                            }
                        }
                        __syncthreads();
                        // Main writes.
                        if (cells_ID_mask[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x] > -1)
                        {
                            if (s_F_pb[(I+1+1)+6*(J+1+-1)+36*(K+1+-1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 26*n_maxcells] = s_F_pb[(I+1+1)+6*(J+1+-1)+36*(K+1+-1)];
                            }
                            if (s_F_p[(I+1+-1)+6*(J+1+1)+36*(K+1+1)] >= 0)
                            {
                                cells_f_F[i_kap_b*M_CBLOCK + i_Q*M_TBLOCK + threadIdx.x + 25*n_maxcells] = s_F_p[(I+1+-1)+6*(J+1+1)+36*(K+1+1)];
                            }
                        }
                        // Neighbor writes.
                        //\t Nbr 1 participates in an exchange for p=26.
                        ...
                        if ((nbr_kap_b >=0) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((I==0)))
                        {
                            if (s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 25*n_maxcells] = s_F_p[ (I+1+-1+(1*4)) + 6*(J+1+1+(0*4)) + 36*(K+1+1+(0*4)) ];
                            }
                        }
                        //\t Nbr 3 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_3;
                        ...
                        if ((nbr_kap_b >=0 ) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)))
                        {
                            if (s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells] = s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(0*4)) ];
                            }
                        }
                        //\t Nbr 5 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_5;
                        ...
                        if ((nbr_kap_b >=0 ) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((K==0)))
                        {
                            if (s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells] = s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(0*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        //\t Nbr 11 participates in an exchange for pb=Lpb(26).
                        nbr_Q_b = nbr_Q_11;
                        ...
                        if ((nbr_kap_b >=0 ) and cells_ID_mask[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x]>-1 and ((J==0)and(K==0)))
                        {
                            if (s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ] >= 0)
                            {
                                cells_f_F[nbr_kap_b*M_CBLOCK + nbr_Q_b*M_TBLOCK + threadIdx.x + 26*n_maxcells] = s_F_pb[ (I+1+1+(0*4)) + 6*(J+1+-1+(1*4)) + 36*(K+1+-1+(1*4)) ];
                            }
                        }
                        __syncthreads();
