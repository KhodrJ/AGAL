...
/*  Last Updated: Tue Jul 22 17:22:37 2025                                            */
/*                                                                                    */
/**************************************************************************************/
...
)
{
    ...
    for (int k = 0; k < M_LBLOCK; k += 1)
    {
        ...
        if ((i_kap_b>-1)&&((valid_block==1)))
        {
            ...
            f_q = cells_f_F[i_kap_b*M_CBLOCK + threadIdx.x + 20*n_maxcells];
            ...
            f_q = cells_f_F[i_kap_b*M_CBLOCK + threadIdx.x + 22*n_maxcells];
            ...
            f_q = cells_f_F[i_kap_b*M_CBLOCK + threadIdx.x + 24*n_maxcells];
            ...
            f_q = cells_f_F[i_kap_b*M_CBLOCK + threadIdx.x + 25*n_maxcells];
...
int Solver_LBM<ufloat_t,ufloat_g_t,AP,LP>::S_ImposeBC_D3Q27(int i_dev, int L)
{
