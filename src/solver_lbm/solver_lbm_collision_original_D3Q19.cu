...
/*  Last Updated: Wed Jul  2 17:36:15 2025                                            */
/*                                                                                    */
/**************************************************************************************/
...
__global__
void Cu_Collision_Original_D3Q19(int n_ids_idev_L,long int n_maxcells,int n_maxcblocks,ufloat_t dx_L,ufloat_t tau_L,int *id_set_idev_L,int *cells_ID_mask,ufloat_t *cells_f_F,ufloat_t *cblock_f_X,int *cblock_ID_nbr,int *cblock_ID_nbr_child,int *cblock_ID_mask,int *cblock_ID_onb)
{
                        ...
                        if (block_on_boundary == 1)
                        {
                            ...
                            if (((i_q==Nqx-1)))
                            {
                                ...
                                if ((I+4*i_q==4*Nqx-1))
                                {
                                    if (nbr_kap_b == -1)
                                    {
                                        ...
                                        f_1 = f_1 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (u);
                                        f_1 = -f_1 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                ...
                                if ((I+4*i_q==4*Nqx-1)and(K+4*k_q<4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                        f_9 = f_9 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (u+w);
                                        f_9 = -f_9 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                ...
                                if ((I+4*i_q==4*Nqx-1)and(J+4*j_q>0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                        f_13 = f_13 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (u)-(v);
                                        f_13 = -f_13 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                ...
                                if ((I+4*i_q==4*Nqx-1)and(K+4*k_q>0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                                        f_15 = f_15 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (u)-(w);
                                        f_15 = -f_15 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.050000000000000);
                            ...
                            if (((i_q==0)))
                            {
                                ...
                                if ((I+4*i_q==0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                        f_2 = f_2 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = -(u);
                                        f_2 = -f_2 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                ...
                                if ((I+4*i_q==0)and(K+4*k_q>0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                        f_10 = f_10 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = -(u+w);
                                        f_10 = -f_10 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                ...
                                if ((I+4*i_q==0)and(J+4*j_q<4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                        f_14 = f_14 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (v)-(u);
                                        f_14 = -f_14 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                ...
                                if ((I+4*i_q==0)and(K+4*k_q<4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                                        f_16 = f_16 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (w)-(u);
                                        f_16 = -f_16 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(-0.050000000000000);
                            ...
                            if (((j_q==Nqx-1)))
                            {
                                ...
                                if ((J+4*j_q==4*Nqx-1))
                                {
                                    if (nbr_kap_b == -1)
                                    {
                                        ...
                                        f_3 = f_3 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (v);
                                        f_3 = -f_3 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                ...
                                if ((J+4*j_q==4*Nqx-1)and(K+4*k_q<4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_11 = f_11 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (v+w);
                                        f_11 = -f_11 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                ...
                                if ((J+4*j_q==4*Nqx-1)and(K+4*k_q>0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_17 = f_17 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (v)-(w);
                                        f_17 = -f_17 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                            ...
                            if (((j_q==0)))
                            {
                                ...
                                if ((J+4*j_q==0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_4 = f_4 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = -(v);
                                        f_4 = -f_4 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                ...
                                if ((J+4*j_q==0)and(K+4*k_q>0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_12 = f_12 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = -(v+w);
                                        f_12 = -f_12 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                ...
                                if ((J+4*j_q==0)and(K+4*k_q<4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_18 = f_18 - (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (w)-(v);
                                        f_18 = -f_18 + (ufloat_t)(2.0)*(ufloat_t)(0.027777777777778)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                            ...
                            if (((k_q==Nqx-1)))
                            {
                                ...
                                if ((K+4*k_q==4*Nqx-1))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_5 = f_5 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = (w);
                                        f_5 = -f_5 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                            ...
                            if (((k_q==0)))
                            {
                                ...
                                if ((K+4*k_q==0))
                                {
                                    ...
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
                                        f_6 = f_6 - (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*(ufloat_t)(3.0)*cdotu;
                                    }
                                    if (nbr_kap_b == -2)
                                    {
                                        cdotu = -(w);
                                        f_6 = -f_6 + (ufloat_t)(2.0)*(ufloat_t)(0.055555555555556)*((ufloat_t)(1.0) + cdotu*cdotu*(ufloat_t)(4.5) - udotu*(ufloat_t)(1.5));
                                    }
                                    if (nbr_kap_b == -3)
                                    {
                                        cdotu = (ufloat_t)(0.000000000000000);
