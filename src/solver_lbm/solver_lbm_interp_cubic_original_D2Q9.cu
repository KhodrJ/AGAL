...
)
{
    ...
    ufloat_t x_kap = (ufloat_t)(-0.083333333333333)+(ufloat_t)(0.166666666666667)*(threadIdx.x % 4);
    ufloat_t y_kap = (ufloat_t)(-0.083333333333333)+(ufloat_t)(0.166666666666667)*((threadIdx.x / 4) % 4);
    int i_kap_b = -1;
    int i_kap_bc = -1;
