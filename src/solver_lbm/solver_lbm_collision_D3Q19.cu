...
__global__
void Cu_Collide_D3Q19(int n_ids_idev_L,long int n_maxcells,int n_maxcblocks,ufloat_t tau_L,int *id_set_idev_L,int *cells_ID_mask,ufloat_t *cells_f_F,int *cblock_ID_nbr,int *cblock_ID_nbr_child,int *cblock_ID_mask,int *cblock_ID_onb)
{
    ...
    for (int k = 0; k < M_LBLOCK; k += 1)
    {
        ...
        if ((i_kap_b>-1)&&((i_kap_bc<0)||(block_on_boundary>=-2) # TODO))
        {
            ...
            u = ((N_Pf(0)*f_0+N_Pf(1)*f_1+N_Pf(-1)*f_2+N_Pf(0)*f_3+N_Pf(0)*f_4+N_Pf(0)*f_5+N_Pf(0)*f_6+N_Pf(1)*f_7+N_Pf(-1)*f_8+N_Pf(1)*f_9+N_Pf(-1)*f_10+N_Pf(0)*f_11+N_Pf(0)*f_12+N_Pf(1)*f_13+N_Pf(-1)*f_14+N_Pf(1)*f_15+N_Pf(-1)*f_16+N_Pf(0)*f_17+N_Pf(0)*f_18)) / rho_kap;
            v = ((N_Pf(0)*f_0+N_Pf(0)*f_1+N_Pf(0)*f_2+N_Pf(1)*f_3+N_Pf(-1)*f_4+N_Pf(0)*f_5+N_Pf(0)*f_6+N_Pf(1)*f_7+N_Pf(-1)*f_8+N_Pf(0)*f_9+N_Pf(0)*f_10+N_Pf(1)*f_11+N_Pf(-1)*f_12+N_Pf(-1)*f_13+N_Pf(1)*f_14+N_Pf(0)*f_15+N_Pf(0)*f_16+N_Pf(1)*f_17+N_Pf(-1)*f_18)) / rho_kap;
            w = ((N_Pf(0)*f_0+N_Pf(0)*f_1+N_Pf(0)*f_2+N_Pf(0)*f_3+N_Pf(0)*f_4+N_Pf(1)*f_5+N_Pf(-1)*f_6+N_Pf(0)*f_7+N_Pf(0)*f_8+N_Pf(1)*f_9+N_Pf(-1)*f_10+N_Pf(1)*f_11+N_Pf(-1)*f_12+N_Pf(0)*f_13+N_Pf(0)*f_14+N_Pf(-1)*f_15+N_Pf(1)*f_16+N_Pf(-1)*f_17+N_Pf(1)*f_18)) / rho_kap;
            udotu = u*u + v*v + w*w;
            ...
            // Perform collision.
            cdotu = (ufloat_t)(0.0);
            f_0 = omegap*f_0 + omega*rho*(ufloat_t)0.333333333333333*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (u);
            f_1 = omegap*f_1 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = -(u);
            f_2 = omegap*f_2 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (v);
            f_3 = omegap*f_3 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = -(v);
            f_4 = omegap*f_4 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (w);
            f_5 = omegap*f_5 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = -(w);
            f_6 = omegap*f_6 + omega*rho*(ufloat_t)0.055555555555556*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (u+v);
            ...
            cdotu = (u+w);
            f_9 = omegap*f_9 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = -(u+w);
            f_10 = omegap*f_10 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (v+w);
            f_11 = omegap*f_11 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = -(v+w);
            f_12 = omegap*f_12 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (u)-(v);
            f_13 = omegap*f_13 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (v)-(u);
            f_14 = omegap*f_14 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (u)-(w);
            f_15 = omegap*f_15 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (w)-(u);
            f_16 = omegap*f_16 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (v)-(w);
            f_17 = omegap*f_17 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
            cdotu = (w)-(v);
            f_18 = omegap*f_18 + omega*rho*(ufloat_t)0.027777777777778*( (ufloat_t)1.0 + (ufloat_t)3.0*cdotu + (ufloat_t)4.5*cdotu*cdotu - (ufloat_t)1.5*udotu );
